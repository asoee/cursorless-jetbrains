...
internal class TalonSettingsConfigurable : Configurable {
    ...
    override fun isModified(): Boolean {
        ...
        return mySettingsComponent!!.hatsScaleFactor.toInt() != state.hatScaleFactor ||
                ...
                mySettingsComponent!!.flasRangeDuration.toInt() != state.flashRangeDuration
    }
    ...
    override fun apply() {
        ...
        state.flashRangeDuration = mySettingsComponent!!.flasRangeDuration.toInt()
    ...
    override fun reset() {
        ...
        mySettingsComponent!!.enableHats = state.enableHats
        mySettingsComponent!!.flasRangeDuration = state.flashRangeDuration.toString()
    }
